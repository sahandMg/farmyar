    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <form onsubmit="submitForm()" method="post" action="{{route('RemoteResendVerification',['locale'=>App::getLocale()])}}" class="login100-form validate-form p-l-55 p-r-55 p-t-178">
                    <ul>
