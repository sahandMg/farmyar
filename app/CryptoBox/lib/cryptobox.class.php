...
//            dd($this->get_json_values());
//            dd(get_object_vars(session('paymentData')['box'])['amount'],$data);
//            $data['amount'] = number_format(get_object_vars(session('paymentData')['box'])['amount'],8);
	    ...
	    $tmp .= "<form action='" . $page_url. "' method='get'>";
